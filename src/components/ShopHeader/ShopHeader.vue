       ...
       <nav class="shop-nav" :style="{backgroundimage:`url(${info.bgImg})`}">
        ...
        <div class="shop-content">
            ...
            <div class="header-content">
                <h2 class="content-title" @click="sholist">
        ...
        <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportsShow"> <!--这里是异步显示数据，数据第三层直接访问会报错，解决方法是使用v-if来判断是否请求成功，成功了才显示数据-->
            <div  class="discounts-left">
                <div class="activity" :class="supportClasses[info.supports[0].type]"><!--这里的类名是会变化的，将用到的类名存储到一个数组中，从数组中获取-->
                    <span class="content-tag">
        ...
        <div class="shop-brief-modal" style="display:none" v-show="supportsShow">
            <div class="brief-modal-content">
                ...
                <ul class="brief-modal-msg">
                    ...
                    <div class="mask-footer" @click="sholist">
                        <span class="iconfont icon-close"></span>
                    </div>              
            </div>
            <div class="brief-modal-cover"></div>
        </div>
        <div class="activity-sheet" style="display:none" v-show="shopShow">
    ...
    .shop-content
        ...
        .header-content
            ...
            .content-title
                ...
                color #333
                .content-tag
                    background-image linear-gradient(90deg, #fff100, #ffe339) //渐变色
                    width 36px
                    height: 18px
                    margin-right 10px
                    color #6a3709
