    ...
    <div class="ratings" ref="ratings">
        <div class="ratings-content">
            ...
            <div class="ratingselect">
                ...
                <div class="switch" :class="{on:onlyShowText}"  @click="toggleOnlyShowText"> <!--类名已经确定了,没有第二个，使用{}对象的方式-->
                    ...
                    <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
                        ...
                        <div class="content">
                            ...
                            <div class="recommend">
                                ...
                                <span class="item" v-if=" rating.recommend" v-for="(item,index) in rating.recommend" :key="index">南瓜粥</span>
...
export default {
    ...
    computed:{
        ...mapState(['ratings','info']),//获取商家信息，评价信息
        ...mapGetters(['positiveSize']), //是对state中的ratings的评价类别进行计算，所以state的计算属性，用getter更加方便 ，计算满意的评价总数
        //根据选择的条目筛选评价
        filterRatings (){
            //得到需要的数据
            ...
            return ratings.filter(rating => {
                const {rateType,text} = rating //解构赋值，取出rating中的两个参数
                /*
                    条件1:
                        selectType: 0/1/2
                        rateType: 0/1
  ...
  .ratings
    ...
    .overview
      ...
      .overview-right
        ...
        @media only screen and (max-width: 320px) //当屏幕尺寸小于320px时，应用下面的css样式
          padding-left: 6px
        .score-wrapper
          margin-bottom: 8px
          font-size: 0
